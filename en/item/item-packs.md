...
- Amounts written on item IDs inside the pack are ignored. Specify the amount at the recipe reference instead, e.g. `item_pack:all_wood 4` (currently only anvil recipes support amounts)
